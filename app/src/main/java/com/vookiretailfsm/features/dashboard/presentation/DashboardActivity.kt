package com.vookiretailfsm.features.dashboard.presentation
...
import com.vookiretailfsm.*
import com.vookiretailfsm.ContactUtils.retrieveAllContacts
import com.vookiretailfsm.R
import com.vookiretailfsm.app.*
import com.vookiretailfsm.app.NewFileUtils.browseDocuments
import com.vookiretailfsm.app.NewFileUtils.getExtension
import com.vookiretailfsm.app.domain.*
import com.vookiretailfsm.app.types.DashboardType
import com.vookiretailfsm.app.types.FragType
import com.vookiretailfsm.app.types.TopBarConfig
import com.vookiretailfsm.app.uiaction.DisplayAlert
import com.vookiretailfsm.app.utils.*
import com.vookiretailfsm.app.utils.AppUtils.Companion.isProfile
import com.vookiretailfsm.base.BaseResponse
import com.vookiretailfsm.base.presentation.BaseActivity
import com.vookiretailfsm.base.presentation.BaseFragment
import com.vookiretailfsm.features.NewQuotation.AddQuotFormFragment
import com.vookiretailfsm.features.NewQuotation.ViewAllQuotListFragment
import com.vookiretailfsm.features.NewQuotation.ViewDetailsQuotFragment
import com.vookiretailfsm.features.SearchLocation.SearchLocationFragment
import com.vookiretailfsm.features.SearchLocation.locationInfoModel
import com.vookiretailfsm.features.TA.ViewAllTAListFragment
import com.vookiretailfsm.features.achievement.AchievementFragment
import com.vookiretailfsm.features.activities.presentation.*
import com.vookiretailfsm.features.addAttendence.*
import com.vookiretailfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.vookiretailfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.vookiretailfsm.features.addAttendence.model.GetReportToFCMResponse
import com.vookiretailfsm.features.addAttendence.model.GetReportToResponse
import com.vookiretailfsm.features.addAttendence.model.Leave_list_Response
import com.vookiretailfsm.features.addorder.presentation.AddOrderFragment
...
import com.vookiretailfsm.features.addshop.presentation.AddShopFragment
import com.vookiretailfsm.features.addshop.presentation.OTPVerificationDialog
import com.vookiretailfsm.features.addshop.presentation.ScanImageFragment
import com.vookiretailfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.vookiretailfsm.features.alarm.model.AlarmData
import com.vookiretailfsm.features.alarm.presetation.AttendanceReportFragment
import com.vookiretailfsm.features.alarm.presetation.PerformanceReportFragment
import com.vookiretailfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.vookiretailfsm.features.alarm.presetation.VisitReportFragment
import com.vookiretailfsm.features.attendance.AttendanceFragment
import com.vookiretailfsm.features.attendance.api.AttendanceRepositoryProvider
...
import com.vookiretailfsm.features.averageshop.presentation.AverageShopFragment
import com.vookiretailfsm.features.avgorder.presentation.AverageOrderFragment
import com.vookiretailfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.vookiretailfsm.features.beatCustom.TeamBeatListFragment
import com.vookiretailfsm.features.billing.presentation.AddBillingFragment
import com.vookiretailfsm.features.billing.presentation.BillingDetailsFragment
import com.vookiretailfsm.features.billing.presentation.BillingListFragment
import com.vookiretailfsm.features.changepassword.presentation.ChangePasswordDialog
import com.vookiretailfsm.features.chat.model.ChatListDataModel
import com.vookiretailfsm.features.chat.model.ChatUserDataModel
import com.vookiretailfsm.features.chat.model.GroupUserDataModel
import com.vookiretailfsm.features.chat.presentation.*
import com.vookiretailfsm.features.chatbot.presentation.ChatBotFragment
import com.vookiretailfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.vookiretailfsm.features.chatbot.presentation.ReportsFragment
import com.vookiretailfsm.features.chatbot.presentation.SelectLanguageDialog
import com.vookiretailfsm.features.commondialog.presentation.CommonDialog
import com.vookiretailfsm.features.commondialog.presentation.CommonDialogClickListener
import com.vookiretailfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.vookiretailfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.vookiretailfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.vookiretailfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.vookiretailfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.vookiretailfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.vookiretailfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.vookiretailfsm.features.damageProduct.ShopDamageProductListFrag
import com.vookiretailfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.vookiretailfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.vookiretailfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.vookiretailfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.vookiretailfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.vookiretailfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.vookiretailfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.vookiretailfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.vookiretailfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.vookiretailfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.vookiretailfsm.features.device_info.presentation.DeviceInfoListFragment
import com.vookiretailfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.vookiretailfsm.features.document.DocumentRepoFeatureNewFragment
import com.vookiretailfsm.features.document.presentation.DocumentListFragment
import com.vookiretailfsm.features.document.presentation.DocumentTypeListFragment
import com.vookiretailfsm.features.document.presentation.OpenFileWebViewFragment
import com.vookiretailfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.vookiretailfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.vookiretailfsm.features.dymanicSection.presentation.DynamicListFragment
import com.vookiretailfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.vookiretailfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.vookiretailfsm.features.home.presentation.HomeFragment
import com.vookiretailfsm.features.homelocation.presentation.HomeLocationFragment
import com.vookiretailfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.vookiretailfsm.features.know_your_state.KnowYourStateFragment
import com.vookiretailfsm.features.lead.LeadFrag
import com.vookiretailfsm.features.lead.ViewLeadFrag
import com.vookiretailfsm.features.leaveapplynew.LeaveHome
import com.vookiretailfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.vookiretailfsm.features.localshops.LocalShopListFragment
import com.vookiretailfsm.features.localshops.LocalShopListMapFragment
import com.vookiretailfsm.features.localshops.NearByShopsMapFragment
import com.vookiretailfsm.features.location.*
import com.vookiretailfsm.features.location.api.LocationRepoProvider
import com.vookiretailfsm.features.location.model.*
import com.vookiretailfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.vookiretailfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.vookiretailfsm.features.login.ShopFeedbackEntity
import com.vookiretailfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.vookiretailfsm.features.login.presentation.LoginActivity
import com.vookiretailfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.vookiretailfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.vookiretailfsm.features.marketing.presentation.MarketingPagerFragment
import com.vookiretailfsm.features.meetinglist.prsentation.MeetingListFragment
import com.vookiretailfsm.features.member.MapViewForTeamFrag
import com.vookiretailfsm.features.member.model.TeamLocDataModel
import com.vookiretailfsm.features.member.model.TeamShopListDataModel
import com.vookiretailfsm.features.member.presentation.*
import com.vookiretailfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.vookiretailfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.vookiretailfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.vookiretailfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.vookiretailfsm.features.myjobs.model.CustomerDataModel
import com.vookiretailfsm.features.myjobs.presentation.*
import com.vookiretailfsm.features.myorder.presentation.MyOrderListFragment
import com.vookiretailfsm.features.myprofile.presentation.MyProfileFragment
import com.vookiretailfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.vookiretailfsm.features.nearbyshops.model.ShopData
import com.vookiretailfsm.features.nearbyshops.model.ShopListResponse
import com.vookiretailfsm.features.nearbyshops.presentation.BeatListFragment
import com.vookiretailfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.vookiretailfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.vookiretailfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.vookiretailfsm.features.newcollection.CollectionDetailsStatusFragment
import com.vookiretailfsm.features.newcollection.CollectionShopListFragment
import com.vookiretailfsm.features.newcollection.NewCollectionListFragment
import com.vookiretailfsm.features.newcollectionreport.*
import com.vookiretailfsm.features.notification.NotificationFragment
import com.vookiretailfsm.features.orderList.NewDateWiseOrderListFragment
import com.vookiretailfsm.features.orderList.NewOrderListFragment
import com.vookiretailfsm.features.orderList.OrderListFragment
import com.vookiretailfsm.features.orderdetail.presentation.OrderDetailFragment
import com.vookiretailfsm.features.orderhistory.ActivityMapFragment
import com.vookiretailfsm.features.orderhistory.OrderhistoryFragment
import com.vookiretailfsm.features.orderhistory.TimeLineFragment
import com.vookiretailfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.vookiretailfsm.features.orderhistory.model.LocationData
import com.vookiretailfsm.features.performance.GpsStatusFragment
import com.vookiretailfsm.features.performance.PerformanceFragment
import com.vookiretailfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.vookiretailfsm.features.performance.model.UpdateGpsInputParamsModel
import com.vookiretailfsm.features.permissionList.ViewPermissionFragment
import com.vookiretailfsm.features.photoReg.PhotoAttendanceFragment
import com.vookiretailfsm.features.photoReg.ProtoRegistrationFragment
import com.vookiretailfsm.features.photoReg.RegisTerFaceFragment
import com.vookiretailfsm.features.photoReg.TeamAttendanceFragment
import com.vookiretailfsm.features.quotation.presentation.*
import com.vookiretailfsm.features.reimbursement.presentation.EditReimbursementFragment
import com.vookiretailfsm.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.vookiretailfsm.features.reimbursement.presentation.ReimbursementFragment
import com.vookiretailfsm.features.reimbursement.presentation.ReimbursementListFragment
import com.vookiretailfsm.features.report.presentation.*
import com.vookiretailfsm.features.returnsOrder.*
import com.vookiretailfsm.features.settings.presentation.SettingsFragment
import com.vookiretailfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.vookiretailfsm.features.shopdetail.presentation.*
import com.vookiretailfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.vookiretailfsm.features.stock.StockDetailsFragment
import com.vookiretailfsm.features.stock.StockListFragment
import com.vookiretailfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.vookiretailfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.vookiretailfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.vookiretailfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.vookiretailfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.vookiretailfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.vookiretailfsm.features.survey.SurveyFrag
import com.vookiretailfsm.features.survey.SurveyViewDtlsFrag
import com.vookiretailfsm.features.survey.SurveyViewFrag
import com.vookiretailfsm.features.task.presentation.AddTaskFragment
import com.vookiretailfsm.features.task.presentation.CalenderTaskFragment
import com.vookiretailfsm.features.task.presentation.EditTaskFragment
import com.vookiretailfsm.features.task.presentation.TaskListFragment
import com.vookiretailfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.vookiretailfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.vookiretailfsm.features.timesheet.presentation.TimeSheetListFragment
import com.vookiretailfsm.features.viewAllOrder.CartFragment
import com.vookiretailfsm.features.viewAllOrder.OrderTypeListFragment
import com.vookiretailfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.vookiretailfsm.features.viewAllOrder.ViewCartFragment
import com.vookiretailfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.vookiretailfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.vookiretailfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.vookiretailfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.vookiretailfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.vookiretailfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.vookiretailfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.vookiretailfsm.features.viewPPDDStock.ViewStockFragment
import com.vookiretailfsm.features.weather.presentation.WeatherFragment
import com.vookiretailfsm.mappackage.MapActivity
import com.vookiretailfsm.mappackage.MapActivityWithoutPath
import com.vookiretailfsm.mappackage.SendBrod
import com.vookiretailfsm.widgets.AppCustomEditText
import com.vookiretailfsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xvookiretailfsmlogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log").path);
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
