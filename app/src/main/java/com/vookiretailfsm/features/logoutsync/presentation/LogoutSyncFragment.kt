package com.vookiretailfsm.features.logoutsync.presentation
...
import com.vookiretailfsm.app.AppDatabase
...
import com.vookiretailfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.vookiretailfsm.features.addshop.api.AddShopRepositoryProvider
import com.vookiretailfsm.features.billing.api.AddBillingRepoProvider
import com.vookiretailfsm.features.billing.model.AddBillingInputParamsModel
...
import com.vookiretailfsm.features.dashboard.presentation.ReasonDialog
...
import com.vookiretailfsm.features.document.model.AddEditDocumentInputParams
import com.vookiretailfsm.features.document.model.DocumentAttachmentModel
...
import com.vookiretailfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.vookiretailfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.vookiretailfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.vookiretailfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.vookiretailfsm.features.orderhistory.model.*
...
import com.vookiretailfsm.features.quotation.model.AddQuotInputModel
import com.vookiretailfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.vookiretailfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.vookiretailfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.vookiretailfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.vookiretailfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.vookiretailfsm.features.timesheet.model.AddTimeSheetInputModel
import com.vookiretailfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.vookiretailfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.vookiretailfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.vookiretailfsm.mappackage.SendBrod
import com.vookiretailfsm.widgets.AppCustomTextView
import com.vookiretailfsm.MonitorService
import com.vookiretailfsm.features.addshop.model.*
import com.vookiretailfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.vookiretailfsm.features.login.api.LoginRepositoryProvider
import com.vookiretailfsm.features.login.model.GetConcurrentUserResponse
import com.vookiretailfsm.features.returnsOrder.ReturnProductList
import com.vookiretailfsm.features.returnsOrder.ReturnRequest
import com.vookiretailfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xvookiretailfsmlogsample/log.zip").path);
